...
const ContingentSignup = () => {
    ...
    const handleGoogleSignup = async () => {
        try {
            ...
            const defaultProfileRef = doc(collection(db, "Contingent Users'25", user.uid, "profiles"));
    ...
    return (
        <div
            className="backgroundDiv min-h-screen flex items-center justify-center"
        >
            {/* Overlay Blur Panel */}
            <div className="bg-gray-600 bg-opacity-10 backdrop-blur-md border border-white border-opacity-20 rounded-xl px-6 py-8 w-[380px] shadow-xl">
                ...
                <form className='myForm' onSubmit={handleSubmit}>
                    ...
                    <p className="text-center text-sm text-white mt-4">
                        ...
                        <Link to="/contingent_login" className="underline text-blue-300">
                            Login
                        </Link>
                    </p>
...
export default ContingentSignup;

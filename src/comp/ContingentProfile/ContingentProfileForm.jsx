...
const ContingentProfileForm = ({ profileId, initialData, user, onDelete }) => {
    ...
    const handleUpdate = async () => {
        ...
        await updateDoc(doc(db, "Contingent Users'25", user.uid, "profiles", profileId), { ...profileData, email: user.email });
        setTimeout(() => {
    ...
    return (
        <div className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 shadow-xl rounded-xl md:w-[50%] w-[95%] mt-3 mb-0 p-6">
            <div className="flex items-center gap-4 relative">
                ...
                <div className="absolute top-0 right-0">
                    <button onClick={handleLogout} className="flex gap-2 items-center justify-center p-2 rounded-lg">
                        <img src="/logout.png" alt="Logout" className="w-10" />
                    </button>
                </div>
                <div className="relative">
                    <h2 className="md:text-3xl text-xl font-semibold text-white mb-2">{profileData.schoolName}</h2>
            ...
            {/* Form Fields */}
            <form className="space-y-4 h-[48vh] overflow-y-auto mt-0 mb-2">

...
const IndividualProfileForm = ({ profileId, initialData, user, onDelete }) => {
    ...
    return (
        <div className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-900 shadow-xl rounded-xl md:w-[50%] w-[95%] mt-3 mb-0 p-6">
            <div className="flex relative items-center gap-4">
                ...
                <div className="absolute top-0 right-0 flex flex-column justify-center">
                    ...
                    <button type="button" onClick={onDelete} className="flex gap-2 items-center justify-center p-2 rounded-lg">
            ...
            {/* Form Fields */}
            <form className="space-y-4 h-[45vh] overflow-y-auto mt-0 mb-2">

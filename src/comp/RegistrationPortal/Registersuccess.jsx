        ...
        <div className="register-success-body">
          <div className="register-success-cont">
            <h1 className="finalmessage">
              Thanks for registering for UNOSQ'23.
            </h1>
            ...
            <ul>
              <li>Registration Deadline: 24 August</li>
            ...
            <p>
              ...
              <a
                href="https://drive.google.com/drive/folders/1WD0k6k4q7zsK_GH4pCTrI0EJ9Q5JSFwB"
                target="_blank"
              >
                https://drive.google.com/drive/folders/1WD0k6k4q7zsK_GH4pCTrI0EJ9Q5JSFwB
              </a>
            </p>
      ...
      {location.pathname == "/contingentregister" && (
        <div className="register-success-body">
          <div className="register-success-cont">
            ...
            <p className="waitmessage">
              Please make a payment of ₹120 × (no. of students) to the following
              Bank Account:
              <ul>

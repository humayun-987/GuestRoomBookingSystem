...
const ContingentLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      navigate(`/contingent_profile/${uid}`);
    } catch (error) {
        ...
        <form onSubmit={handleSignin} className="myForm">
          ...
          <div className="mb-4 relative">
            <input
              ...
              className="w-full px-4 py-2 rounded-full bg-transparent border border-white text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-2 pr-12"
              required
            />
            <button
              type="button"
          ...
          <p className="text-center text-sm text-white mt-4">
            ...
            <Link to="/contingent_signup" className="underline text-blue-300">
              Sign up
            </Link>
          </p>
...
export default ContingentLogin;
